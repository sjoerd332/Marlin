...
#define TEMP_SENSOR_BED 5 // Sjoerd: or 1
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_DEFAULT_POINTS 7 // Sjoerd: was 7
  #endif
  ...
  #define DELTA_PRINTABLE_RADIUS 72.0     // (mm)
  ...
  #define DELTA_RADIUS 95.0              // (mm) Get this value from G33 auto calibrate. Sjoerd: was 105, Sjoerd: extruder update 110 naar 95
...
#define USE_ZMIN_PLUG // the Z probe
...
#define Z_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. Sjoerd: extruder update
#define X_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Z_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Z_MIN_PROBE_ENDSTOP_INVERTING true // Set to true to invert the logic of the probe. Sjoerd: extruder update
...
//#define Z_PROBE_ALLEN_KEY
  ...
  #define DELTA_PROBABLE_RADIUS 50.0
  // Kossel Mini
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 1.0 } // Sjoerd: default probe offset
...
#define Z_PROBE_LOW_POINT          -20 // Farthest distance below the trigger-point to go before stopping // Sjoerd: from -2 to x, physical height slightly more than sw height: more range required here.
...
// :[-1,1]
#define X_HOME_DIR 1 // delta home towards max
#define Y_HOME_DIR 1
#define Z_HOME_DIR 1
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define ENABLE_LEVELING_FADE_HEIGHT Sjoerd: nice to have?
  ...
  #define GRID_MAX_POINTS_X 7 // Sjoerd veranderen naar 3?
...
#define MANUAL_Z_HOME_POS DELTA_HEIGHT // Distance between the nozzle to printbed after homing, Sjoerd: todo
